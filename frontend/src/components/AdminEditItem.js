...
const AdminEditItem = ({
 ...
 const handlesubmit = async(e) =>{
    ...
    console.log("API URL:", summaryApi.UpdateProduct.url);
  ...
  return (
    ...
    <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-y-auto">
       ...
       <div className="flex justify-center items-center">
         <h2 className="font-bold text-lg">Edite Item</h2>
       ...
       <div>
         ...
         <label htmlFor="Price">Price:</label>
           ...
           <button className=' px-3 py-2 bg-blue-800 text-white mb-6 top-1 hover:bg-blue-900'>Update Item</button>
       </form>
     </div>
   </div>
  )
